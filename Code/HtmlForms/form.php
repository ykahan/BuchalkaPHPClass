...
<body>
	<form method="post">
		...
		<div>
			...
			<label for="cat">Cats</label><input id="cat" type="radio" name="pref_animal" value="cat"><br>
			<label for="dog">Dogs</label><input id="dog" type="radio" name="pref_animal" value="dog" checked>
		</div>
		<input name="username">
